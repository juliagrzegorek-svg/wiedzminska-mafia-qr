...
export const MONSTER_ABILITIES = [
  {
    id: "strzyga-bite",
    title: "Strzyga — Ugryzienie",
    description:
      "NOCĄ możesz ugryźć jedną osobę. Umiera następną nocą, chyba że zostanie uleczona.",
  },
  {
    id: "upior-curse",
    title: "Upiór — Klątwa",
    description:
      "Wybierasz cel — jego głos podczas następnego głosowania nie będzie liczony.",
  },
  {
    id: "wilkolak-hunt",
    title: "Wilkołak — Polowanie",
    description:
      "Wspólnie z innymi potworami wybierasz ofiarę. Jeśli jest sama, atak się powodzi.",
  },
  {
    id: "wampir-drain",
    title: "Wampir — Wysysanie",
    description:
      "Możesz oznaczyć gracza ugryzieniem. Umiera kolejnej nocy, jeśli nie zostanie wyleczony.",
  },
  {
    id: "bruxa-song",
    title: "Bruxa — Krzyk",
    description:
      "RAZ NA GRĘ: ogłuszasz wybraną osobę. Nie może użyć zdolności tej nocy.",
  },
];
