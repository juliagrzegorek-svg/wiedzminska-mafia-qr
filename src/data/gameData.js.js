// src/data/gameData.js — ścieżki pod PNG i polskie nazwy potworów
...
export const HEROES = [
  ...
  // opcjonalni obywatele, jeśli chcesz ich w grze:
...
export const MONSTERS = [
  { id: "vampire",  name: "Wampir",   image: IMG.vampire,  description: "Założyciel Mrocznego Kręgu. PIERWSZEJ NOCY rytualnie gryzie ofiarę — ta osoba umrze DRUGIEJ nocy (chyba że wyleczona)." },
  { id: "strzyga",  name: "Strzyga",  image: IMG.strzyga,  description: "Nocą bierze udział w wyborze ofiary razem z potworami." },
  { id: "werewolf", name: "Wilkołak", image: IMG.werewolf, description: "Nocą bierze udział w wyborze ofiary razem z potworami." },
  { id: "bruxa",    name: "Bruxa",    image: IMG.bruxa,    description: "Nocą bierze udział w wyborze ofiary razem z potworami." },
  { id: "upior",    name: "Upiór",    image: IMG.upior,    description: "Nocą bierze udział w wyborze ofiary razem z potworami." },
];
