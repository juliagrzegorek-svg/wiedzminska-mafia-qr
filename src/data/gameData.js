...
export const IMG = {
  ...
  // (opcjonalni) dodatkowi bohaterowie
  avallach: "/assets/heroes/avallach.png",
  fringilla: "/assets/heroes/fringilla.png",

  // POTWORY
  vampire: "/assets/monsters/wampir.png", // jeśli masz np. vampire.png, zmień!
  strzyga: "/assets/monsters/strzyga.png",
  werewolf: "/assets/monsters/wilkolak.png", // jeśli masz wilkolak.png
  bruxa: "/assets/monsters/bruxa.png",
  upior: "/assets/monsters/upior.png",
};

// Zdolności (Twoje teksty)
...
// BOHATEROWIE (kanonowa zdolność w baseAbilityId)
export const HEROES = [
  ...
  // (opcjonalnie) dodatkowi obywatele
