      ...
      <Drawer open={open} onClose={() => setOpen(false)}>
        <div className="mb-4 flex flex-wrap gap-2">
          ...
          <button
            className={cls(
              "rounded-xl border px-3 py-1.5 text-sm",
              tab === "functions" ? "border-zinc-500 bg-zinc-800 text-white" : "border-zinc-700 bg-zinc-900 text-zinc-300"
            )}
          ...
          <button
            className={cls(
              "rounded-xl border px-3 py-1.5 text-sm",
              tab === "pairs" ? "border-zinc-500 bg-zinc-800 text-white" : "border-zinc-700 bg-zinc-900 text-zinc-300"
            )}
