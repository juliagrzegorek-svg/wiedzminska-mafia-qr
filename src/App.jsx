...
function SmartImg({ src, kind, id, name }) {
  ...
  if (!url) return <div style={{width:'100%',height:'100%',display:'flex',alignItems:'center',justifyContent:'center',opacity:.7,fontSize:12}}>(brak obrazu)</div>;
...
// === KONIEC nagłówka; dalej może lecieć Twój komponent App itd. ===
